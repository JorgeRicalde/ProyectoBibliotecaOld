const frmHistorialSancion = $(`form#frmHistorialSancion`);
...
$(document).on("click", "#btnFiltrar", function () {
    let formData = new FormData(frmHistorialSancion.get(0));
                ...
                <div class="col-12 col-xl-6">
                    <div class="card card-danger">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-12">
                                    <h5 class="float-left"><b>Sancion: ${formatSancionCodigo(
                                        unHistorial["id"]
                                    )}
                                     <br>${
                                         unHistorial["fecha_sancion"]
                                     }</b></h5>
                                    <h4 class="float-right"><b class="badge badge-success">${
                                        unHistorial["estado_de_la_sancion"]
                                    }</b></h4>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-12 col-md-7 align-self-center">
                                <div class="card bg-gradient-primary">
                                    <div class="card-body">
                                        ...
                                        <p><b>Tipo Sancion:</b> ${
                                            unHistorial["tipo_de_sancion"]
                                        }</p>
                                        <p><b>Fecha Inicio:</b> ${
                                            unHistorial["fecha_inicio"]
                                        }</p>
                                        <p><b>Fecha Finalizacion:</b> ${
                                            unHistorial["fecha_fin"]
                                        }</p>
                                    </div>
                                </div>
                            </div>
