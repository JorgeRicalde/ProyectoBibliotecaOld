...
@section('content_header')
    <h1 class='m-0 text-white'>Historial de Sanciones</h1>
@stop
                ...
                <div class='card-body'>
                    <div class="card">
                        <div class="card-header text-center">
                            <h3 class='m-0 text-white' id="frmTitulo">Historial de Sanciones
                                <x-adminlte-button id="btnFiltrar" theme="outline-success" icon="fas fa-search fa-lg" />
                            </h3>

                        </div>
                        <div class="card-body">
                            <form id="frmHistorialSancion">
                                <div class="form-row">
...
@section('js')
    <script>
        const url = {
            historial: '{{ route('sancion.misSanciones') }}'
        }
    </script>
    <script src="{{ asset('js/configuracion.js') }}"></script>
    <script src="{{ asset('js/historialsanciones.js') }}"></script>
@stop
